...
extension Gen where Value == Float {
    ...
    /// - Returns: A generator of random values within the bounds of range.
    @inlinable
    public static func float(in range: Range<Float>) -> Generator<Float, Shrink.Floating<Float>> { return value(in: range) }
}
...
extension Gen where Value == Double {
    ...
    /// - Returns: A generator of random values within the bounds of range.
    @inlinable
    public static func double(in range: Range<Double>) -> Generator<Double, Shrink.Floating<Double>> { return value(in: range) }
}
...
extension Gen where Value == Float16 {
    ...
    /// - Returns: A generator of random values within the bounds of range.
    @inlinable
    public static func float16(in range: Range<Float16>) -> Generator<Float16, Shrink.Floating<Float16>> { return value(in: range) }
}
...
extension Gen where Value == Float80 {
    ...
    /// - Returns: A generator of random values within the bounds of range.
    @inlinable
    public static func float80(in range: Range<Float80>) -> Generator<Float80, Shrink.Floating<Float80>> { return value(in: range) }
}
#endif
...
extension Gen where Value == CGFloat {
    ...
    /// - Returns: A generator of random values within the bounds of range.
    @inlinable
    public static func cgFloat(in range: Range<CGFloat>) -> Generator<CGFloat, Shrink.Floating<CGFloat>> { return value(in: range) }
}
#endif
